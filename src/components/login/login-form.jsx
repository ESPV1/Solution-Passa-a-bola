  ...
  return (
    <form className={className} onSubmit={handleSubmit(onSubmit)}>
      <Input label='Email' name='email' type='email'
        register={register} errors={errors} required autoComplete="email"
      />
      <Input label='Senha' name='password' type='password'
        register={register} errors={errors} required showPasswordToggle autoComplete="current-password"
      />
      ...
      <div className="flex text-sm gap-1">
        ...
        <Link to='/user-type' className="text-rose-500 underline hover:no-underline">
