  ...
  return (
    <main className="min-h-screen w-full bg-white text-slate-900">
      <section className="mx-auto w-full max-w-7xl px-6 py-8">
        <h1 className="text-2xl font-bold text-rose-600 mb-6">Lista de Jogadoras</h1>
              ...
              {listaPlayers.map((player) => (
                ...
                >
                  ...
                  <div className="text-center">
                    <p className="font-semibold text-slate-800 text-lg">{player.nome}</p>
                    <p className="text-sm text-rose-600 font-medium">{player.posicao}</p>
                    <p className="text-xs text-slate-600">
                      {player.idade} anos • {player.time}
                    </p>
                    <p className="text-xs text-slate-500">{player.nacionalidade}</p>
                  </div>

                  {/* estatísticas */}
                  <div className="flex justify-center gap-4 text-xs text-slate-600 bg-white rounded-lg p-2 w-full">
                    <div className="text-center">
                      <p className="font-semibold text-rose-600">{player.rating}</p>
                      <p>Rating</p>
                    </div>
                    <div className="text-center">
                  ...
                  {/* botão para ver mais informações sobre a jogadora */}
