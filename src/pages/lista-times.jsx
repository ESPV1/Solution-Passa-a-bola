          ...
          <aside className="order-1 lg:order-2 lg:col-span-1 rounded-2xl border border-rose-200 bg-white p-4 shadow-sm">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2 pt-1">
                ...
                <button className="flex-1 sm:flex-none rounded-lg border border-rose-300 text-rose-700 px-3 py-2 text-sm hover:bg-rose-50 transition-colors duration-200 cursor-pointer">
                  Limpar
                </button>
              </div>
            </div>
          ...
          <div className="order-2 lg:order-1 lg:col-span-3 rounded-2xl border border-rose-200 p-4 sm:p-6 bg-white shadow-sm">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
              {listaTimes.map((t) => (
                ...
                >
                  <div className="w-28 h-28 sm:w-32 sm:h-32 md:w-40 md:h-40 rounded-lg bg-rose-100 flex items-center justify-center">
                    <img
                      src={t.logo}
                      alt={`Logo do ${t.nome}`}
